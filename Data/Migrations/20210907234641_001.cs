        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GithubUrl = table.Column<string>(type: "character varying(175)", maxLength: 175, nullable: true),
                    TwitterUrl = table.Column<string>(type: "character varying(175)", maxLength: 175, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abstract = table.Column<string>(type: "character varying(350)", maxLength: 350, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Body = table.Column<string>(type: "character varying(700)", maxLength: 700, nullable: false),
                    Created = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Updated = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    ...
                    ModeratedBody = table.Column<string>(type: "character varying(700)", maxLength: 700, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostId = table.Column<int>(type: "integer", nullable: false),
                    BlogUserId = table.Column<string>(type: "text", nullable: true),
                    Text = table.Column<string>(type: "character varying(35)", maxLength: 35, nullable: false)
                },
                constraints: table =>
                {
